...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from '@gemswap-libs/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} WAKANDA`)}
